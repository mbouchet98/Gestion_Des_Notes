...
public class Eleve_Adapter_Spinner_Activity  extends ArrayAdapter<Classe> {

    private int resourceLayout;
    private Context mContext;

    public Eleve_Adapter_Spinner_Activity(Context context, int resource, List<Classe> uneList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ClasseEleveViewHolder viewHolder = (ClasseEleveViewHolder) convertView.getTag();
        if(viewHolder == null){
            viewHolder = new ClasseEleveViewHolder();
            viewHolder.nomClasse = (Spinner) convertView.findViewById(R.id.droptxtEleve);
        ...
        Classe uneclasse = getItem(position);
        //Classe unClasse =

        //Log.v("matiere", unEleve.getLibClasse());

        //il ne reste plus qu'à remplir notre vue
         viewHolder.nomClasse.setPrompt(uneclasse.getLibClasse());
    ...
    class ClasseEleveViewHolder {
        public Spinner nomClasse;
